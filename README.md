...
### **Overview**
Music Bike is an embedded systems project aimed at creating a hardware-software solution that adapts music playback in real time by responding to a cyclist's riding style. By leveraging sensors to collect data such as speed, pitch, roll, yaw, angular velocity, and acceleration. With these parameters, Music Bike can adapt the tempo, instrumentation, and endless other features powered by the professional FMOD Studio audio engine.
...
- **App Integration**: Connected Android app. Uses FMOD Studio and BLE to play adaptive music
...
- **Sensors**: Speed sensor (hall effect), IMU (MPU9250)
...
├── /tensorflow         # Firmware code and music adaptation algorithms
...
### **License**
See MIT License. Please note that FMOD Studio and the FMOD Studio API have their own licensing requirements that should be respected. FMOD Studio licensing can be reviewed [here](https://www.fmod.com/licensing). All sound effects used in the app or FMOD bank files are in the public domain.
